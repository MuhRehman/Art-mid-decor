...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('info@artminddecor.com', 'Rehman1');
        $mail->addAddress('info@artminddecor.com', 'Rehman2');     // Add a recipient
                // Name is optional
...
<li id="mobile-menu-item-427" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-308 current_page_item active"><a href="index.html" class=" current "><span>Contact Us</span></a><span class="mobile_arrow"><i class="fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span></li>
...
</div></div></div></div></div><div      class="vc_row wpb_row section vc_row-fluid  vc_custom_1456911573069 grid_section" style=' text-align:center;'><div class=" section_inner clearfix"><div class='section_inner_margin clearfix'><div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-offset-3 vc_col-lg-6"><div class="vc_column-inner"><div class="wpb_wrapper">
	...
	</div> </div></div></div></div></div></div><div      class="vc_row wpb_row section vc_row-fluid  vc_custom_1456911944161 grid_section" style=' text-align:left;'><div class=" section_inner clearfix"><div class='section_inner_margin clearfix'><div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6"><div class="vc_column-inner vc_custom_1456911787818"><div class="wpb_wrapper"><div class="separator  transparent   " style="margin-top: 2px;margin-bottom: 0px;"></div>
<div role="form" class="wpcf7" id="wpcf7-f314-p308-o1" lang="en-US" dir="ltr">
<div class="screen-reader-response"></div>
<form action="" method="post" class="wpcf7-form cf7_custom_style_2" novalidate="novalidate">
...
<p><span class="wpcf7-form-control-wrap full-name"><input type="text" name="name" value="" size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Your name" /></span></p>
...
<p><span class="wpcf7-form-control-wrap message"><textarea name="msg" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Message"></textarea></span></p>
...
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-3 vc_col-md-3 vc_col-xs-12"><div class="vc_column-inner vc_custom_1456911800626"><div class="wpb_wrapper"><div class="separator  transparent   " style="margin-top: 2px;margin-bottom: 0px;"></div>
