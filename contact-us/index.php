			...
			<span aria-hidden="true" class="qode_icon_font_elegant icon_menu " ></span>		</span>
								...
								<div class="q_logo">
										<a itemprop="url" href="../index.html" >
											 <img itemprop="image" class="normal" src="../gallery/newlogo1.png" alt="Logo"> 	
													  <img itemprop="image" class="light" src="../gallery/newlogo1.png" alt="Logo"/> 		
													   <img itemprop="image" class="dark" src="../gallery/newlogo1.png" alt="Logo"/> 		
															<img itemprop="image" class="sticky" src="../gallery/newlogo1.png" alt="Logo"/> 		
																 <img itemprop="image" class="mobile" src="../gallery/newlogo1.png" alt="Logo"/> 		
									 </a>
									</div>
	</div>															</div>
															...
															<div class="side_menu_button_wrapper right">
																					<div class="header_bottom_right_widget_holder"><div class="header_bottom_widget widget_text">			<div class="textwidget"><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;margin: 0 8px 0 5px;font-size: 13px;font-size: 18px;border-radius: 3px; ">
																						<a   itemprop="url" href="https://www.facebook.com/Art-Mind-Technical-Service-102081934825563/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_facebook qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a>
																					</span><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;margin: 0 8px 0 0;font-size: 13px;font-size: 18px;border-radius: 3px; ">
																						<a   itemprop="url" href="http://twitter.com/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_twitter qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a></span><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;font-size: 13px;font-size: 18px;border-radius: 3px; ">
																							<a   itemprop="url" href="https://www.instagram.com/artmind123/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_instagram qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a></span></div>
		                                   </div></div>
...
<div class='google_map_shortcode_holder' style='height:300px;'><div class='qode_google_map' style='height:300px;' id='map_canvas_88959' data-addresses='["united arab emirates"]' data-custom-map-style='false' data-color-overlay='#393939' data-saturation='-100' data-lightness='-60' data-zoom='5' data-pin='https://alzadcarpentry.com/wp-content/uploads/2016/03/pin.png' data-unique-id='88959' data-google-maps-scroll-wheel='false' data-snazzy-map-style='no' data-map-height='300'></div><div class='google_map_shortcode_overlay'></div></div><div class="separator  transparent   " style="margin-top: 58px;margin-bottom: 0px;"></div>
	...
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
		<ul class="thememount_vc_contact_wrapper">
<li class="thememount-contact-phonenumber tmicon-fa-phone">00971.50.1780115</li>
<li class="thememount-contact-phonenumber tmicon-fa-phone">00971. 56.8344370</li>
<li class="thememount-contact-email tmicon-fa-envelope-o"><a href="mailto:info@artminddecor.com">info@artminddecor.com</a></li>
<li class="thememount-contact-website tmicon-fa-globe"><a href="../index.html">https://www.artminddecor.com/</a></li>
<li class="thememount-contact-address tmicon-fa-map-marker">Art Mind Decor Service LLC<br />
P.O BOX 186692<br />
Shop no 1&2 owner sheikha Muhara Ahmad Majid Al ghuriar Diera Al qousis Dubai</li>
</ul>
				...
				<div class="footer_top_holder">
					...
					<div class="container_inner">
							...
							<div class="footer_bottom_holder">
													...
													<div class="textwidget"><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;margin: 0 8px 0 0;font-size: 13px;font-size: 18px;border-radius: 3px; "><a   itemprop="url" href="https://www.facebook.com/Art-Mind-Technical-Service-102081934825563/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_facebook qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a></span><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;margin: 0 8px 0 0;font-size: 13px;font-size: 18px;border-radius: 3px; "><a   itemprop="url" href="http://twitter.com/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_twitter qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a></span><span data-type="square" data-hover-bg-color="#ffffff" data-hover-icon-color="#000000" class="qode_icon_shortcode fa-stack q_font_awsome_icon_square fa-lg  " style="background-color: rgba(255,255,255,0.01);border: 2px solid #ffffff;font-size: 13px;font-size: 18px;border-radius: 3px; "><a   itemprop="url" href="https://www.instagram.com/artmind123/" target="_blank"><span aria-hidden="true" class="qode_icon_font_elegant social_instagram qode_icon_element" style="font-size: 13px;color: #ffffff;" ></span></a></span></div>
